    ...
    <div class="result1">
      <table class="table">
        <tbody>
          ...
          $sql = "SELECT * FROM preemploye_wanita WHERE rm = '$rm'";;
      ...
      <tbody>
        ...
        if ($result->num_rows > 0) {
          ...
          while ($row = $result->fetch_assoc()) {
            ...
            echo "<tr><td>&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<strong>Gravidex Tes :</strong></td><td>"  . $row["gravidex"] . "";

            echo "<tr><td>&emsp;&emsp;<strong>c. Urinalisa :</strong></td><td>";
