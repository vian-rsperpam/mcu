...
<head>
  ...
  <title>Hasil Medical Check UP standart</title>
...
<body>
  ...
  <div class="container mt-5">
    <h2>Hasil Medical Check Up Standart</h2>
    <div class="mb-3">
      <div class="btn-group">
    ...
    <form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="mb-3">
      ...
      <table class="table table-striped">
        ...
        <tbody>
          ...
          $sql = "SELECT * FROM standart WHERE nama LIKE '%$search_nama%' AND rm LIKE '%$search_rm%'";
